 ...
 * date   : 2020/5/2615:09
 */
public class OrderShoppingAdapter extends BaseQuickAdapter<OrderInfoData.ListBean.ProductsBean, BaseViewHolder> {
    Context activity;
    public OrderShoppingAdapter(Context activity, @Nullable List<OrderInfoData.ListBean.ProductsBean> data) {
