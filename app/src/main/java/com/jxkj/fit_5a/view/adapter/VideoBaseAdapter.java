...
public abstract class VideoBaseAdapter<T, K extends VideoBaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public VideoBaseAdapter(List<T> list) {
        this.list = list;
    }
        ...
        if (getItemClickListener() != null) {
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    getItemClickListener().onItemClick(VideoBaseAdapter.this, v, holder.getLayoutPosition());
                }
            });
        }
        ...
        if (getItemLongClickListener() != null) {
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return getItemLongClickListener().onItemLongClick(VideoBaseAdapter.this, v, holder.getLayoutPosition());
                }
            });
        }
    ...
    public interface onItemClickListener {
        void onItemClick(VideoBaseAdapter adapter, View view, int position);


    }

    public interface OnItemLongClickListener {
        boolean onItemLongClick(VideoBaseAdapter adapter, View view, int position);
    }
