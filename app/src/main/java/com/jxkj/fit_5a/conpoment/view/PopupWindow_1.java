...
public class PopupWindow_1 extends PopupWindow {

    Context mcontext;

    @SuppressLint("ClickableViewAccessibility")
    public PopupWindow_1(Activity context, GiveDialogInterface dialogInterface) {
        super(context);
        this.mcontext = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View view = inflater.inflate(R.layout.dialog_exercise_1, null);
