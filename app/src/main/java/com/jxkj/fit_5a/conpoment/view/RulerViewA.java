...
public class RulerViewA extends View {
    ...
    public RulerViewA(Context context) {
        this(context, null);

    }

    public RulerViewA(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RulerViewA(Context context, AttributeSet attrs, int defStyleAttr) {
