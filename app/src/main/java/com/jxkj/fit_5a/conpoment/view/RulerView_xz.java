...
public class RulerView_xz extends View {
    ...
    public RulerView_xz(Context context) {
        this(context, null);

    }

    public RulerView_xz(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RulerView_xz(Context context, AttributeSet attrs, int defStyleAttr) {
