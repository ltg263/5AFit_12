...
public class MagicIndicatorScaleCircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private MagicIndicatorScaleCircleNavigator.OnCircleClickListener mCircleClickListener;
    ...
    public MagicIndicatorScaleCircleNavigator(Context context) {
        super(context);
        init(context);
    }
