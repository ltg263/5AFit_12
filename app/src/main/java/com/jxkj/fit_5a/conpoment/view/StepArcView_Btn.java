 ...
 * 显示步数的圆弧
 */
public class StepArcView_Btn extends View {
    /**
     * 圆弧的宽度
     */
    ...
    public StepArcView_Btn(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public StepArcView_Btn(Context context, AttributeSet attrs, int defStyleAttr) {
 ...
 */
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(R.color.color_ffffff));//设置画笔颜色
     ...
     */
    public void setCurrentCount(int totalStepNum, int currentCounts,CurrentAngleInterface currentAngleInterface) {
        ...
        float currentAngleLength = scale * angleLength;
            /**开始执行动画*/
        setAnimation(0, currentAngleLength, animationLength,currentAngleInterface);
    }

    public interface CurrentAngleInterface {
        void complete();
    }
     ...
     * @param current
     */
    private void setAnimation(float last, float current, int length,CurrentAngleInterface currentAngleInterface) {
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.w("currentAngleLength","currentAngleLength"+currentAngleLength);
                if(currentAngleInterface!=null && currentAngleLength==360){
                    currentAngleInterface.complete();
                }
                invalidate();
            }
        });
