...
import com.jxkj.fit_5a.AAChartCoreLib.AATools.AAJSStringPurer;

import java.util.HashMap;
import java.util.Map;


public class AAChartViewOne extends WebView {

    public boolean isOnClick = true;
    public interface AAChartViewCallBack {
        void chartViewDidFinishLoad(AAChartViewOne aaChartView);
        void chartViewMoveOverEventMessage(
                AAChartViewOne aaChartView,
...
//                Log.i("js files load","图表加载完成!!!!!!!! ");
                ...
                if (callBack != null) {
                    callBack.chartViewDidFinishLoad(AAChartViewOne.this);
                }
            }
        });
    }
